#!/bin/bash
# Simple memory-only training script
...
OUTPUT_DIR="work_dirs/memory-only-training"
NUM_GPUS=1
...
echo "=========================================="
echo "Memory-Only Fine-Tuning"
echo "=========================================="
echo "Model: ${MODEL_PATH}"
echo "Memory: L_w=${MEMORY_L_W}, L_e=${MEMORY_L_E}"
echo "Output: ${OUTPUT_DIR}"
echo ""
echo "FROZEN: Vision, Language Model, Spatial, Fusion"
echo "TRAINED: Dual-Memory + Projector (~12M + projector params)"
echo ""
echo "NOTE: Training projector is recommended because:"
echo "  - Memory outputs differ from original features"
echo "  - Projector needs to adapt to memory-enhanced features"
echo "  - This is a standard fine-tuning pattern"
echo "=========================================="
...
torchrun \
    ...
    --report_to wandb \
    --run_name "memory-only-${MEMORY_L_W}-${MEMORY_L_E}" \
    \
    ...
    --mm_tunable_parts "dual_memory,mm_mlp_adapter" \
