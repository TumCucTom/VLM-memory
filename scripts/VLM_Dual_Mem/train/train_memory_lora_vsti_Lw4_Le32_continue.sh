...
#   2. dual-memory weights unfrozen
#
# Warm start:
#   - load VSTI task LoRA as trainable
#   - overlay the current trained memory checkpoint on top
...
RUN_NAME="${RUN_NAME:-vlm2-memory-lora-vsti-Lw4-Le32-32f-${RUN_STAMP}}"
...
echo "=========================================="
echo "VSTI memory continuation: LoRA + dual memory"
echo "=========================================="
